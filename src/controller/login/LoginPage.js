...
import {getLoginForm, getRememberedPath, setLoginForm, setToken} from "../../utils/auth";
import {getRandom} from "../../utils/ComUtils";
...
import {login} from "../../store/modules/appState";
          ...
          <Form onSubmit={this.handleSubmit} className={classes.loginForm}>
            <Form.Item>
              {getFieldDecorator('username', {
                ...
                <Input allowClear prefix={<Icon type="user" style={{color: 'rgba(0,0,0,.25)'}}/>}
                       placeholder="账户" onChange={v => this.props.form.setFieldsValue({password: ''})}/>
              )}
            </Form.Item>
            <Form.Item>
              {getFieldDecorator('password', {
                ...
                <Input.Password visibilityToggle
                                ...
                                placeholder="密码" onChange={e => this.setState({fromCookie: false})}/>
              )}
            </Form.Item>
            <div>
